...
!!! info "3e · Séquence 4 · De la carte Arduino au robot mBot · Séance 6 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/3e-arduino-mbot-seance6-trace.pdf)
...
|---|---|---|---|
| **T3.2** | Valider les solutions techniques par des simulations ou des protocoles de tests | Analyser | 6, 7, 8, 13 |
| **T2.1** | Décrire l'organisation interne d'un objet et ses échanges avec son environnement | Comprendre | 1, 2, 3, 4, 5, 11 |
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 9, 10, 12 |
