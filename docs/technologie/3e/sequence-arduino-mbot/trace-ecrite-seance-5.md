...
!!! info "3e · Séquence 4 · De la carte Arduino au robot mBot · Séance 5 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/3e-arduino-mbot-seance5-trace.pdf)
...
|---|---|---|---|
| **T2.1** | Décrire l'organisation interne d'un objet et ses échanges avec son environnement | Comprendre | 1, 2, 3, 4, 5, 6, 11, 13 |
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Appliquer | 8, 9 |
| **T3.2** | Valider les solutions techniques par des simulations ou des protocoles de tests | Analyser | 7, 10, 12 |
