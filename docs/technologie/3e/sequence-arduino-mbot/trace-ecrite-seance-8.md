...
!!! info "3e · Séquence 4 · De la carte Arduino au robot mBot · Séance 8 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/3e-arduino-mbot-seance8-trace.pdf)
...
|---|---|---|---|
| **T3.2** | Valider les solutions techniques par des simulations ou des protocoles de tests | Analyser | 1, 2, 3, 6, 9, 10, 11, 13 |
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 4, 5, 7, 8, 12 |
