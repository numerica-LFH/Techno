...
!!! info "3e · Séquence 4 · De la carte Arduino au robot mBot · Séance 3 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/3e-arduino-mbot-seance3-trace.pdf)
...
|---|---|---|---|
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Comprendre | 2, 5, 6, 8, 9, 12, 13 |
