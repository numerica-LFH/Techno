...
!!! info "Séance 4 sur 10 · 55 minutes · Demi-groupe"
    ...
    [Fiche élève à imprimer (PDF)](fiches/3e-arduino-mbot-seance4-eleve.pdf)
...
c\. J'écris les lignes à ajouter juste avant `digitalWrite(LED, HIGH);`.

d\. Quel test faut-il refaire après la correction ?
