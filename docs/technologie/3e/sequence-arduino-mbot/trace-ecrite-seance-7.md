...
!!! info "3e · Séquence 4 · De la carte Arduino au robot mBot · Séance 7 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/3e-arduino-mbot-seance7-trace.pdf)
...
|---|---|---|---|
| **T2.1** | Décrire l'organisation interne d'un objet et ses échanges avec son environnement | Identifier | 1, 2, 3, 4, 5, 13 |
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Comprendre | 6, 7, 8, 9, 10, 11, 12 |
