...
!!! info "Séance 6 sur 8 · 55 minutes · Demi-groupe"
    ...
    [Fiche élève à imprimer (PDF)](fiches/3e-jeu-video-seance6-eleve.pdf)
...
d\. Pourquoi le panier ne prend-il que l'abscisse x du nez, et pas y ?

Je teste avec et sans visage devant la caméra, puis j'enregistre **CUEILLETTE-v3**.

### Activité 3 · Un écran titre avec Scratch Lab

Sur lab.scratch.mit.edu, j'ouvre l'expérience **Animated Text**. Ses blocs sont en anglais. Je crée un fichier séparé **CUEILLETTE-titre** avec le titre animé du jeu.

![Exemple d'écran titre dans Scratch Lab (blocs en anglais)](img/sb-660ac47db7.svg)

*Exemple d'écran titre dans Scratch Lab (blocs en anglais)*

e\. Pourquoi faire l'écran titre dans un fichier séparé ?

f\. Le jour de la Nuit du Code, pourra-t-on utiliser cet écran titre ? Pourquoi ?

### Mon défi

!!! example "Mon défi · 3e"

    Le panier tremble quand le visage bouge peu. Je propose une modification pour le rendre plus stable.
...
Les blocs de Scratch Lab posent un problème de **compatibilité** : on les garde dans un fichier séparé.
