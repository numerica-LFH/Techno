...
!!! info "5e · Séquence projet · Inventer un jeu vidéo · Séance 2 sur 8"
    ...
    [Trace écrite à imprimer (PDF)](traces/5e-jeu-video-seance2-trace.pdf)
...
|---|---|---|---|
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Comprendre | 1, 2, 3, 4, 5, 6, 9, 11 |
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 7, 8, 10 |
