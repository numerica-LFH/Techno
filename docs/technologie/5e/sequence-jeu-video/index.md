...
[Fiche séquence à imprimer (PDF)](fiches/5e-jeu-video-fiche-sequence.pdf)
...
|---|---|---|---|---|---|
| 1 | Classe entière | [Qu'est-ce qui fait marcher un jeu vidéo ?](seance-1.md) | Entrées, traitement, sorties ; Scratch et Scratch Lab | [Trace écrite](trace-ecrite-seance-1.md) | [PDF](fiches/5e-jeu-video-seance1-eleve.pdf) |
| 2 | Demi-groupe | [Faire bouger un lutin au clavier](seance-2.md) | Coordonnées x et y, boucle, condition ; CUEILLETTE-v1 | [Trace écrite](trace-ecrite-seance-2.md) | [PDF](fiches/5e-jeu-video-seance2-eleve.pdf) |
| 3 | Classe entière | [Règles, algorithme et variables](seance-3.md) | Robot joueur débranché, algorigramme, carte d'identité du jeu | [Trace écrite](trace-ecrite-seance-3.md) | [PDF](fiches/5e-jeu-video-seance3-eleve.pdf) |
