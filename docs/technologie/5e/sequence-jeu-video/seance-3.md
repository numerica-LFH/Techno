...
!!! info "Séance 3 sur 8 · 55 minutes · Classe entière"
    ...
    [Fiche élève à imprimer (PDF)](fiches/5e-jeu-video-seance3-eleve.pdf)
...
![Algorigramme de la Mangue : la flèche de gauche ramène au début de la boucle](img/flow-561ed21092.svg)
...
!!! abstract "Pour information : les variables du jeu"

    Le jeu retient trois **variables** : le **score** (0 au départ, + 1 à chaque mangue), les **vies** (3 au départ, - 1 à chaque scarabée) et la **vitesse** de chute (5 au départ).
