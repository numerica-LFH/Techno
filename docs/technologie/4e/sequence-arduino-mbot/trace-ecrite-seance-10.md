...
!!! info "4e · Séquence 4 · De la carte Arduino au robot mBot · Séance 10 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/4e-arduino-mbot-seance10-trace.pdf)
...
| **T3.2** | Valider les solutions techniques par des simulations ou des protocoles de tests | Analyser | 8, 9, 10 |
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 4, 5, 6, 7 |
