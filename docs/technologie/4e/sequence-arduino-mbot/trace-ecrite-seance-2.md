...
!!! info "4e · Séquence 4 · De la carte Arduino au robot mBot · Séance 2 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/4e-arduino-mbot-seance2-trace.pdf)
...
|---|---|---|---|
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 1, 2, 3, 4, 5, 6, 7, 11, 12 |
