...
!!! info "4e · Séquence 4 · De la carte Arduino au robot mBot · Séance 9 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/4e-arduino-mbot-seance9-trace.pdf)
...
|---|---|---|---|
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Comprendre | 1, 2, 3, 4, 7, 12 |
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Analyser | 5, 6, 8, 11 |
