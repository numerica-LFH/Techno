...
!!! info "4e · Séquence 4 · De la carte Arduino au robot mBot · Séance 1 sur 10"
    ...
    [Trace écrite à imprimer (PDF)](traces/4e-arduino-mbot-seance1-trace.pdf)
...
|---|---|---|---|
| **T2.1** | Décrire l'organisation interne d'un objet et ses échanges avec son environnement | Identifier | 1, 2, 3, 4, 12 |
| **T2.3** | Comprendre et modifier un programme associé à une fonctionnalité | Comprendre | 5, 6, 7, 8, 10 |
