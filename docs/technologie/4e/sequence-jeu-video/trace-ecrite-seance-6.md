...
!!! info "4e · Séquence projet · Inventer un jeu vidéo · Séance 6 sur 8"
    ...
    [Trace écrite à imprimer (PDF)](traces/4e-jeu-video-seance6-trace.pdf)
...
### Scratch Lab et la compatibilité

L'écran titre en texte animé se fait dans Scratch Lab, avec des blocs en anglais. Un projet qui contient ces blocs ne s'ouvre pas dans Scratch : on le garde dans un fichier séparé. Le jour de la Nuit du Code, on travaille dans Scratch uniquement, et la webcam est déconseillée.
...
| **compatibilité** | la possibilité d'ouvrir un fichier dans un autre logiciel ou une autre version |
...
|---|---|---|---|
| **T3.3** | Concevoir, écrire, tester et mettre au point un programme | Appliquer | 1, 2, 3, 4, 5, 6, 9, 11, 13 |
| **T1.2** | Décrire les interactions entre un objet, son environnement et les utilisateurs | Analyser | 7, 8, 10, 12 |
