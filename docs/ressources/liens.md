...
| Outil | Lien | Usage |
|---|---|---|
| SketchUp Free | [app.sketchup.com](https://app.sketchup.com/) | Modélisation 3D dans le navigateur, compte gratuit requis |
| SketchUp for Schools | [edu.sketchup.com](https://edu.sketchup.com/) | Version scolaire, connexion avec le compte de l'établissement |
| Tinkercad | [tinkercad.com](https://www.tinkercad.com/) | Modélisation 3D simple, circuits électroniques, blocs de code |
...
Schools demande que l'établissement ouvre les comptes, ce qui donne accès à
l'export vers l'impression 3D. Les fichiers se conservent dans Trimble Connect
ou dans le Drive de l'élève selon la formule.
