...
# ASSR, attestations de sécurité routière

Les attestations scolaires de sécurité routière sont passées au collège. Elles conditionnent
l'accès à la conduite d'un cyclomoteur puis à l'apprentissage de la conduite automobile.
...
Les plateformes officielles proposent des séries d'entraînement identiques à l'épreuve.

- [Préparer l'ASSR 1 et l'ASSR 2 sur le site officiel](https://preparer-assr.education.gouv.fr/){ target=_blank }
- [Ressources de la Sécurité routière](https://www.securite-routiere.gouv.fr/){ target=_blank }
